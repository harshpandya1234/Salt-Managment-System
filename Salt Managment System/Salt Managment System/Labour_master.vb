Public Class Labour_master
    ...
    Private Sub loaddata()
        ...
        ds = d.load_dataset("select Labour_Name,Labour_Address,Labour_Number,Labour_Salary,id from Labour_master")
                    ...
                    If TextBox3.Text <> " " Then
                        If TextBox4.Text <> " " Then
                            If saveflag = 0 Then
                                ...
                                da.adddata("insert into Labour_master (Labour_Name,Labour_Address,Labour_Number,Labour_Salary) values ('" & TextBox1.Text & "','" & TextBox2.Text & "', '" & TextBox3.Text & "', " & TextBox4.Text & ")")
                            ...
                            Else
                                ...
                                If TextBox4.Text <> " " AndAlso IsNumeric(TextBox4.Text) Then
                                    Dim da As New DAOCLASS
                                    da.adddata("update Labour_master Set Labour_Name='" & TextBox1.Text & "',Labour_Address='" & TextBox2.Text & "',Labour_Number='" & TextBox3.Text & "',Labour_Salary= " & TextBox4.Text & ")'")
                                    MessageBox.Show("Record Updated")
                                Else
                                    MessageBox.Show("Enter valid Record")
                                    ToolStripButton1_Click(sender, e)
                                End If
                            End If
                        Else
    ...
    Private Sub ToolStripButton3_Click(sender As Object, e As EventArgs) Handles ToolStripButton3.Click
        Try
            If DataGridView1.RowCount > 0 Then
                Dim d As Integer = MessageBox.Show("Do You Want to Delete " & DataGridView1.Item("Labour_Name", DataGridView1.CurrentCell.RowIndex).Value & "?", "Message", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1)
                If d = 6 Then
                    Dim dA As New DAOCLASS
                    dA.adddata("delete from Labour_master where id=" & DataGridView1.Item("id", DataGridView1.CurrentCell.RowIndex).Value)
                    loaddata()
    ...
    Private Sub Labour_master_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        loaddata()
    End Sub
    ...
    Private Sub Labour_master_Load_1(sender As Object, e As EventArgs) Handles MyBase.Load
