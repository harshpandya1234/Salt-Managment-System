Public Class Product_master
    ...
    Private Sub loaddata()
        ...
        ds = d.load_dataset("select Name,Grade,Rate,Unit,id from Product_master")
                    ...
                    If TextBox3.Text <> " " Then
                        If TextBox4.Text <> " " Then
                            If saveflag = 0 Then
                                ...
                                da.adddata("insert into Product_master (Name,Grade,Rate,Unit) values ('" & TextBox1.Text & "','" & TextBox2.Text & "', '" & TextBox3.Text & "', '" & TextBox4.Text & "')")
                            ...
                            Else
                                ...
                                If TextBox4.Text <> " " AndAlso IsNumeric(TextBox4.Text) Then
                                    Dim da As New DAOCLASS
                                    da.adddata("update Product_master Set Name='" & TextBox1.Text & "',Grade='" & TextBox2.Text & "',Rate='" & TextBox3.Text & "',Unit='" & TextBox4.Text & "')'")
    ...
    Private Sub ToolStripButton3_Click(sender As Object, e As EventArgs) Handles ToolStripButton3.Click
        Try
            If DataGridView1.RowCount > 0 Then
                Dim d As Integer = MessageBox.Show("Do You Want to Delete " & DataGridView1.Item("Name", DataGridView1.CurrentCell.RowIndex).Value & "?", "Message", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button1)
                If d = 6 Then
                    Dim dA As New DAOCLASS
                    dA.adddata("delete from Product_master where id=" & DataGridView1.Item("id", DataGridView1.CurrentCell.RowIndex).Value)
                    loaddata()
    ...
    Private Sub Product_master_Load_1(sender As Object, e As EventArgs) Handles MyBase.Load
